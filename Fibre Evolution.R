...
tiff("Fig6.9.tiff", units="in", width=10.28, height=7.9, res=300)
...
tiff("Fig6.10a.tiff", units="in", width=9.35, height=7.9, res=300)
...
tiff("Fig6.11.tiff", units="in", width=9.35, height=6.3, res=300)
...
tiff("Fig6.12.tiff", units="in", width=9.35, height=6.3, res=300)
...
tiff("Fig6.10b.tiff", units="in", width=9.35, height=7.9, res=300)

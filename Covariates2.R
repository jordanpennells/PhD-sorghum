...
Biochem_Biomass_Symbols_Publication <- subset(Biochem_Biomass_Symbols,subset=(Biomass == 'Sorghum'|
                                                                                Biomass =='Softwood'|
                                                                                Biomass =='Sugarcane'|
                                                                                Biomass =='Banana'|
                                                                                Biomass == 'Spinifex'))

tiff("Fig 2.tiff", units="in", width=15, height=8, res=300)


p <- ggplot(subset(Biochem_Biomass_Symbols_Publication, Biochemical %in% c("C.H"))) +
  aes(x=Biomass, y=Content) +
  geom_point(size=5, aes(shape = Section, color = Biochemical)) +   # Draw points
  scale_shape_manual(values=c(12,
                              15,
...
CH <- p + facet_grid(rows = vars(Treatment), cols = vars(Biochemical)) +
  theme_bw() +
...
p <- ggplot(subset(Biochem_Biomass_Symbols_Publication, Biochemical %in% c("C.L"))) +
  aes(x=Biomass, y=Content) +
  geom_point(size=5, aes(shape = Section, color = Biochemical)) +   # Draw points
  scale_shape_manual(values=c(12,
                              15,
...
CL <- p + facet_grid(rows = vars(Treatment), cols = vars(Biochemical)) +
  theme_bw() +
theme(strip.text.y = element_blank(), 
...
p <- ggplot(subset(Biochem_Biomass_Symbols_Publication, Biochemical %in% c("H.L"))) +
  aes(x=Biomass, y=Content) +
  geom_point(size=5, aes(shape = Section, color = Biochemical)) +   # Draw points
  scale_shape_manual(values=c(12,
                              15,
...
HL <- p + facet_grid(rows = vars(Treatment), cols = vars(Biochemical)) +
  theme_bw() +
  theme( 
        axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
tiff("Fig1.tiff", units="in", width=15, height=8, res=300)

p_pub <- ggplot(subset(Biochem_Biomass_Symbols_Publication, Biochemical %in% c("Cellulose"))) +
  aes(x=Biomass, y=Content) + 
  geom_point(size=5, aes(shape = Section, color = Biochemical)) +   # Draw points
  scale_shape_manual(values=c(12,
                              15,
...
C <- p_pub + facet_grid(rows = vars(Treatment), cols = vars(Biochemical)) +
  theme_bw() +
  theme(strip.text.y = element_blank()) + 
  guides(color = "none", shape = "none")
...
p_pub <- ggplot(subset(Biochem_Biomass_Symbols_Publication, Biochemical %in% c("Hemicellulose"))) +
  aes(x=Biomass, y=Content) + 
  geom_point(size=5, aes(shape = Section, color = Biochemical)) +   # Draw points
  scale_shape_manual(values=c(12,
                              15,
...
H <- p_pub + facet_grid(rows = vars(Treatment), cols = vars(Biochemical)) +
  theme_bw() + 
  theme(strip.text.y = element_blank(), 
        axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
p_pub <- ggplot(subset(Biochem_Biomass_Symbols_Publication, Biochemical %in% c("Lignin"))) +
  aes(x=Biomass, y=Content) + 
  geom_point(size=5, aes(shape = Section, color = Biochemical)) +   # Draw points
  scale_shape_manual(values=c(12,
                              15,
...
L <- p_pub + facet_grid(rows = vars(Treatment), cols = vars(Biochemical)) +
  theme_bw() + 
  theme(strip.text.y = element_blank(), 
        axis.title.y=element_blank(),
        axis.text.y=element_blank(),
...
p_pub <- ggplot(subset(Biochem_Biomass_Symbols_Publication, Biochemical %in% c("Ash"))) +
  aes(x=Biomass, y=Content) + 
  geom_point(size=5, aes(shape = Section, color = Biochemical)) +   # Draw points
  scale_shape_manual(values=c(12,
                              15,
...
A <- p_pub + facet_grid(rows = vars(Treatment), cols = vars(Biochemical)) +
  theme_bw() + 
  theme(axis.title.y=element_blank(),
        axis.text.y=element_blank(),
        axis.ticks.y=element_blank()) +
